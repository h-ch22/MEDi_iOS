...
struct Buy_Family: View {
    @Environment(\.colorScheme) var colorScheme
    
    @Binding var showModalSelect : Bool
    @State private var showModalSuccess = false
    ...
    @State public var price : Int = 15000
            ...
            ScrollView{
                VStack {
                    ...
                    Button(action: {
                        ...
                        saveUserData().sendUserData(name: self.name, phone: self.phone, dollName: self.doll, date: dateString, email: self.email, address: self.address, isSet: true)
                    ...
                    .navigationBarTitle(Text("의약외품 세트 구입하기"), displayMode: .inline)
...
struct Buy_Family_Previews: PreviewProvider {
